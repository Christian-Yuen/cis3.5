// user_profile.js - Firebase v8 (compat) version
document.addEventListener('DOMContentLoaded', function() {
            ...
            .then(function(querySnapshot) {
                ...
                querySnapshot.forEach(function(doc) {
                    ...
                    if (data.userId === userId) {
                        ...
                        if (imageURL) {
                            // Try to extract filename from URL or use as is
        ...
        db.collection('items').get()
            .then(function(querySnapshot) {
                ...
                querySnapshot.forEach(function(doc) {
                    ...
                    // Check if this item is reserved by the current user
    ...
    function extractFilenameFromURL(url) {
        try {
            ...
            // If no slashes found, return the original URL
            return url;
        }
    }
